...
class DashboardGrid extends Component
{
    ...
    public function mount()
    {
        ...
        $this->modules = [
            'users' => [
                'name' => 'Usuarios & Roles',
                'description' => 'Administra jerarquías y accesos.',
            ...
            'employees' => [
                'name' => 'Empleados',
                'description' => 'Administra empleados y trabajadores.',
            ...
            'tickets' => [
                ...
                'description' => 'Bandeja de solicitudes y peticiones.',
            ...
            'cms' => [
                'name' => 'Portal Web (CMS)',
                'description' => 'Editor visual y publicaciones.',
            ...
            'documents' => [
                ...
                'description' => 'Archivos y expedientes online.',
            ...
            'settings' => [
                ...
                'description' => 'Configuración de entorno del sistema.',
            ...
            'billing' => [
                'name' => 'Facturación',
                'description' => 'Recibos y métodos de pago.',
            ...
            'chat' => [
                'name' => 'Chat Interno',
                'description' => 'Comunicación de equipo.',
            ...
            'shipments' => [
                'name' => 'Envíos',
                'description' => 'Realizar envíos a cliente final',
            ...
            'notes' => [
                'name' => 'Notas',
                'description' => 'Escribir notas personales',
            ...
            'quotatios' => [
                'name' => 'Cotizaciones',
                'description' => 'Realiza y administra cotizaciones',
            ...
            'returns' => [
                'name' => 'Devoluciones',
                'description' => 'Administrar devoluciones',
            ...
            'picking' => [
                'name' => 'Picking',
                'description' => 'Realiza picking para surtir pedidos',
            ...
            'suppliers' => [
                'name' => 'Proveedores',
                'description' => 'Administra proveedores y pedidos',
            ...
            'feedback' => [
                'name' => 'Comentarios',
                'description' => 'Administra los comentarios de la gente',
            ...
            'calendar' => [
                'name' => 'Calendario',
                'description' => 'Administra los eventos proximos',
            ...
            'putaway' => [
                'name' => 'Putaway',
                'description' => 'Almacenaje de productos',
            ...
            'shop' => [
                'name' => 'Compras',
                'description' => 'Realiza y administra compras',
